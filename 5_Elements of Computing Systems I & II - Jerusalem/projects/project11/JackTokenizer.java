...
public class JackTokenizer {
    ...
    /* 
     * keywordMap used to check type of keyword, e.g. class, if, etc., and returned in keyword()
     * opSet used in compileExpression() to check for valid operations  
     */
    static {
     ...
     * @return
     */
    public boolean validOp(Character command) {
	return opSet.contains(command);
    }
